...
# Combine coefficients and variable names into a DataFrame
coefficients_df = pd.DataFrame({'Variable': X.columns, 'Coefficient': lr_model.coef_})

# Export coefficients to Excel
coefficients_df.to_excel("linear_regression_coefficients.xlsx", index=False)
